...
public final class DubboGreeterTriple {
    ...
    org.apache.dubbo.tri.unary.GreeterRequest.class, org.apache.dubbo.tri.unary.GreeterReply.class, serviceDescriptor, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.tri.unary.GreeterRequest::parseFrom,
    org.apache.dubbo.tri.unary.GreeterReply::parseFrom);

    private static final StubMethodDescriptor greetAsyncMethod = new StubMethodDescriptor("greet",
    org.apache.dubbo.tri.unary.GreeterRequest.class, java.util.concurrent.CompletableFuture.class, serviceDescriptor, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.tri.unary.GreeterRequest::parseFrom,
    org.apache.dubbo.tri.unary.GreeterReply::parseFrom);
    ...
    public static class GreeterStub implements Greeter{
        ...
        @Override
        public org.apache.dubbo.tri.unary.GreeterReply greet(org.apache.dubbo.tri.unary.GreeterRequest request){
            return StubInvocationUtil.unaryCall(invoker, greetMethod, request);
        }

        public CompletableFuture<org.apache.dubbo.tri.unary.GreeterReply> greetAsync(org.apache.dubbo.tri.unary.GreeterRequest request){
            return StubInvocationUtil.unaryCall(invoker, greetAsyncMethod, request);
        }

        @Override
        public void greet(org.apache.dubbo.tri.unary.GreeterRequest request, StreamObserver<org.apache.dubbo.tri.unary.GreeterReply> responseObserver){
    ...
    public static abstract class GreeterImplBase implements Greeter, ServerService<Greeter> {
        ...
        public final Invoker<Greeter> getInvoker(URL url) {
            ...
            BiConsumer<org.apache.dubbo.tri.unary.GreeterRequest, StreamObserver<org.apache.dubbo.tri.unary.GreeterReply>> greetFunc = this::greet;
            handlers.put(greetMethod.getMethodName(), new UnaryStubMethodHandler<>(greetFunc));
            BiConsumer<org.apache.dubbo.tri.unary.GreeterRequest, StreamObserver<org.apache.dubbo.tri.unary.GreeterReply>> greetAsyncFunc = syncToAsync(this::greet);

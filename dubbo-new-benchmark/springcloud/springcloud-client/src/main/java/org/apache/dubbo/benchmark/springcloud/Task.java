...
import org.apache.dubbo.benchmark.springcloud.controller.HelloController;
import org.apache.dubbo.benchmark.springcloud.service.HelloClient;
    ...
    public void runTask(ConfigurableApplicationContext context) {
        ...
        try {
            testDriver.runBenchmark(() -> {
                ...
                LOGGER.info("Receive result ======> {}", message);
            });
